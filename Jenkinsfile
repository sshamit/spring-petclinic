        ...
        stage('Deploy to Staging') {
            steps {
                ...
                sh '''
                        ...
                        ssh root@52.116.3.216 "rm -rf /root/temp-deploy/;"
                        scp -pr ./target/*.jar root@52.116.3.216:/root/temp-deploy/
                        ssh root@52.116.3.216 "cd /root/temp-deploy/ && java -jar target/*.jar"
